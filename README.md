...
**Примечание:** Без API ключа каталог будет использовать только кэшированные данные (если есть). Кэш обновляется автоматически каждые 24 часа при наличии API ключа и активного интернет-соединения. Кэш обновляется автоматически каждые 24 часа при наличии API ключа.
